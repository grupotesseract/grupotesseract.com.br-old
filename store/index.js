...
export const state = () => ({
  about: {
    topTitle: 'QUEM',
    bottomTitle: 'SOMOS',
    text: 'Grupo de profissionais da área de TI que acredita na importância da transparência e da cultura colaborativa em seus processos. Oferecemos serviços dos mais variados tipos, como: desenvolvimento de SITES, APLICATIVOS, SISTEMAS EMPRESARIAIS e SOLUÇÔES DE INFRAESTRUTURA.'
  },
  projectGallery: {
    header: {
      topTitle: 'PROJETOS',
